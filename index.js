...
function draw() {
    ...
    if (!start) {
        ...
        context.textBaseline = 'top';
        context.fillStyle = '#000';
        context.fillText("click on me for start", game.width / 2, game.height / 2 + 25);
...
function init() {
    ...
    game.lose = 0;
    // Ракетки-игроки
    ai = new Rect("#ff66ff", 10, game.height / 2 - 40, 20, 80);
    player = new Rect("#66b2ff", game.width - 30, game.height / 2 - 40, 20, 80);
    // количество очков
    ai.scores = 0;
    player.scores = 0;
    // наш квадратный игровой "шарик"
    ball = new Rect("#CCFFCC", 40, game.height / 2 - 10, 20, 20);
    // скорость шарика
